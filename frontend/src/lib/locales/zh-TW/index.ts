...
export const zhTW = {
  ...
  searchPage: {
    ...
    searchCoverageText: "文字搜尋會比對來源標題與內容、洞察，以及筆記標題與內容。",
    searchCoverageVector: "向量搜尋會透過語意相似度比對來源內容、洞察與筆記內容。標題不會被比對。",
    searchType: "搜尋類型",
    ...
    searchNotes: "搜尋筆記",
    scopeNotebooks: "筆記本",
    scopeAllNotebooks: "所有筆記本",
    scopeNotebooksSelected: "已選擇 {{count}} 個",
    scopeClear: "清除",
    scopeHint: "不勾選任何項目則搜尋整個知識庫。",
    scopeNoNotebooks: "還沒有筆記本。",
  ...
  podcasts: {
    ...
    speakerProfileMissing: "缺少講者設定檔",
    speakerProfileMissingDesc: "此單集設定檔引用的講者設定檔已不存在。請編輯設定檔並選擇一個講者設定檔。",
    ...
    maxTokensInteger: "必須為整數",
    maxTokensPositive: "必須為正整數",
  ...
  settings: {
    ...
    jina: "Jina",
    crawl4ai: "Crawl4AI",
    enableDoclingHint: "Docling 為選用項目。使用 OPEN_NOTEBOOK_ENABLE_DOCLING=true 啟用，首次啟動時安裝（下載較大）。",
    enableCrawl4aiHint: "本機 Crawl4AI 為選用項目。使用 OPEN_NOTEBOOK_ENABLE_CRAWL4AI=true 啟用（首次啟動時安裝），或設定 CRAWL4AI_API_URL 以使用遠端伺服器。",
    urlHelp: "· Firecrawl: 強大的付費服務（有免費額度）。 · Jina: 優秀的備選方案，同樣提供免費額度。 · Crawl4AI: 在本機算繪 JavaScript 頁面（或在設定 CRAWL4AI_API_URL 時透過 Crawl4AI 伺服器），無需 API 金鑰。 · Simple: 基礎 HTTP 提取，在 JS 渲染的網站上可能會丟失內容。 · 自動 (推薦): 優先嘗試 Firecrawl，其次 Jina，然後 Crawl4AI，最後回退至 Simple。",
    ...
    formulasEnabled: "擷取公式",
    formulasHelp: "使用 Docling 引擎時，將數學公式擷取為結構化標記。會增加處理時間。",
  ...
  models: {
    ...
    usingChatModelHint: "使用聊天模型（{{model}}）",
    ttsUnsetHint: "未設定 — 設定前無法生成音訊",
    sttUnsetHint: "未設定 — 設定前無法轉錄",
  ...
  apiKeys: {
    title: "模型",
    description: "連接您的 AI 服務商，並安全地儲存其憑證。",
