...
export const jaJP = {
  common: {
    ...
    itemNotFound: "指定された{{type}}は見つかりませんでした",
    contentUnavailable: {
    ...
    accessibility: {
      transformationViews: "変換表示",
      searchKB: "ナレッジベース内を検索・質問",
      enterQuestion: "ナレッジベースへの質問を入力してください",
      enterSearch: "検索クエリを入力",
      searchKBBtn: "ナレッジベース内を検索",
  ...
  apiErrors: {
    ...
    transformationNotFound: "変換が見つかりません",
  ...
  sources: {
    ...
    selectTransformation: "変換を選択...",
    noInsightsYet: "インサイトがまだありません",
    createFirstInsight: "上の変換を使って最初のインサイトを作成しましょう",
    ...
    batchCommonSettings: "同じノートブックと変換がすべてのアイテムに適用されます。",
  ...
  searchPage: {
    ...
    searchCoverageText: "テキスト検索は、ソースのタイトルとコンテンツ、インサイト、ノートのタイトルとコンテンツを検索します。",
    searchCoverageVector: "ベクトル検索は、意味的な類似性に基づいてソースのコンテンツ、インサイト、ノートのコンテンツを検索します。タイトルは検索されません。",
    searchType: "検索タイプ",
    ...
    searchNotes: "ノートを検索",
    scopeNotebooks: "ノートブック",
    scopeAllNotebooks: "すべてのノートブック",
    scopeNotebooksSelected: "{{count}} 件選択中",
    scopeClear: "クリア",
    scopeHint: "何も選択しなければナレッジベース全体を検索します。",
    scopeNoNotebooks: "ノートブックはまだありません。",
  ...
  podcasts: {
    ...
    maxTokensInteger: "整数で入力してください",
    maxTokensPositive: "正の整数で入力してください",
  ...
  settings: {
    ...
    formulasEnabled: "数式を抽出する",
    formulasHelp: "Doclingエンジン使用時に、数式を構造化されたマークアップとして抽出します。処理時間が増加します。",
  ...
  transformations: {
    ...
    playground: "プレイグラウンド",
    defaultPrompt: "デフォルト変換プロンプト",
    defaultPromptDesc: "これはすべての変換プロンプトに追加されます",
    defaultPromptPlaceholder: "デフォルトの変換指示を入力...",
    listTitle: "カスタム変換",
    createNew: "新規作成",
    inputLabel: "入力テキスト",
    ...
    runTest: "変換を実行",
    running: "実行中...",
    selectToStart: "変換を選択して開始",
    name: "名前",
    namePlaceholder: "一意の識別子、例: key_topics",
    titlePlaceholder: "表示タイトル、空欄の場合は名前を使用",
    promptPlaceholder: "この変換を実行するプロンプトを書いてください...",
    descriptionPlaceholder: "この変換の機能を説明してください。",
    suggestDefault: "新しいソースでデフォルトで提案",
    promptHint: "プロンプトはソースコンテンツを念頭に置いて書いてください。モデルに要約、インサイトの抽出、テーブルなどの構造化出力の生成を依頼できます。",
    createSuccess: "変換を作成しました",
    updateSuccess: "変換を更新しました",
    deleteSuccess: "変換を削除しました",
    noTransformations: "変換がまだありません",
    createOne: "開始するには変換を作成してください",
    selectModel: "モデルを選択",
  ...
  models: {
    ...
    usingChatModelHint: "チャットモデルを使用中（{{model}}）",
    ttsUnsetHint: "未設定 — 設定するまで音声生成は利用できません",
    sttUnsetHint: "未設定 — 設定するまで文字起こしは利用できません",
    requiredModelPlaceholder: "⚠️ 必須 - モデルを選択",
    chatModelLabel: "チャットモデル",
    chatModelDesc: "チャット会話に使用",
    transformationModelLabel: "変換モデル",
    transformationModelDesc: "要約、インサイト、変換に使用",
  ...
  apiKeys: {
    title: "モデル",
    description: "AIプロバイダーを接続し、認証情報を安全に保存します。",
