...
export const esES = {
  ...
  searchPage: {
    ...
    scopeNotebooks: "Cuadernos",
    scopeAllNotebooks: "Todos los cuadernos",
    scopeNotebooksSelected: "{{count}} seleccionado(s)",
    scopeClear: "Limpiar",
    scopeHint: "Deja todo sin marcar para buscar en toda la base de conocimiento.",
    scopeNoNotebooks: "Aún no hay cuadernos.",
  ...
  apiKeys: {
    title: "Modelos",
    description: "Conecta tus proveedores de IA y guarda sus credenciales de forma segura.",
    ...
    learnMore: "Aprende a conectar proveedores de IA →",
