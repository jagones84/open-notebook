...
export const bnIN = {
  ...
  searchPage: {
    ...
    searchCoverageText: "টেক্সট অনুসন্ধান সোর্সের শিরোনাম ও বিষয়বস্তু, অন্তর্দৃষ্টি এবং নোটের শিরোনাম ও বিষয়বস্তু খুঁজে পায়।",
    searchCoverageVector: "ভেক্টর অনুসন্ধান সোর্সের বিষয়বস্তু, অন্তর্দৃষ্টি এবং নোটের বিষয়বস্তু শব্দার্থিক সাদৃশ্যের ভিত্তিতে খুঁজে পায়। শিরোনাম মেলানো হয় না।",
    ...
    scopeNotebooks: "নোটবুক",
    scopeAllNotebooks: "সব নোটবুক",
    scopeNotebooksSelected: "{{count}} টি নির্বাচিত",
    scopeClear: "মুছুন",
    scopeHint: "সম্পূর্ণ জ্ঞানভান্ডারে অনুসন্ধান করতে কোনোটি নির্বাচন করবেন না।",
    scopeNoNotebooks: "এখনও কোনো নোটবুক নেই।",
  ...
  apiKeys: {
    title: "মডেলগুলি",
    description: "আপনার AI প্রোভাইডারগুলিকে সংযুক্ত করুন এবং তাদের শংসাপত্র নিরাপদে সংরক্ষণ করুন।",
    ...
    learnMore: "AI প্রোভাইডার সংযুক্ত করা শিখুন →",
