...
export const ruRU = {
  ...
  discover: {
    title: "Discover",
    subtitle: "Search the web and add the best results to a notebook as sources.",
    topicLabel: "Topic",
    topicPlaceholder: "e.g. quantum computing basics",
    notebookLabel: "Notebook",
    notebookPlaceholder: "Select a notebook",
    noNotebooks: "Create a notebook first, then come back to discover sources.",
    limitLabel: "Maximum results",
    dryRunLabel: "Preview only (do not add sources)",
    submit: "Search",
    submitting: "Searching...",
    summary: "{{created}} created, {{skipped}} skipped",
    openNotebook: "Open notebook",
    emptyState: "No results yet. Search a topic to see candidates here.",
    colTitle: "Title",
    colUrl: "Source",
    colScore: "Score",
    colStatus: "Status",
    ...
    statusCreated: "Added",
    statusSkipped: "Already present",
    statusError: "Rejected",
  },
  artifacts: {
    title: "Artifacts",
    subtitle: "Generate a report or a slide deck from a notebook's sources.",
    formTitle: "Generate an artifact",
    notebookLabel: "Notebook",
    notebookPlaceholder: "Select a notebook",
    noNotebooks: "Create a notebook first, then come back to generate an artifact.",
    kindLabel: "Type",
    kindReport: "Report",
    kindDeck: "Slides",
    variantLabel: "Style",
    variantDocument: "Document - prose, shapes the argument",
    variantIllustrated: "Illustrated - prose and diagrams",
    variantPresenter: "Presenter slides - concise bullets",
    variantDetailed: "Detailed deck - full sentences per bullet",
    titleLabel: "Document title (optional)",
    titlePlaceholder: "e.g. DGX Spark overview",
    formatsLabel: "Output formats",
    languageLabel: "Language",
    sectionsLabel: "Sections",
    submit: "Generate",
    submitting: "Submitting...",
    listTitle: "Generated artifacts",
    emptyState: "No artifacts yet. Generate one from a notebook above.",
    colTitle: "Title",
    colKind: "Type",
    colStatus: "Status",
    colCreated: "Created",
    ...
    deleteDesc: "The artifact record and its files will be permanently deleted.",
    startedTitle: "Artifact queued",
    startedDesc: "Generation started. It will appear here when it is ready.",
    deletedTitle: "Artifact deleted",
    deletedDesc: "The artifact and its files have been removed.",
    noFileYet: "No file yet",
    openNote: "Open notebook",
  },
  navigation: {
    artifacts: "Artifacts",
    discover: "Discover",
  ...
  searchPage: {
    ...
    searchCoverageText: "Текстовый поиск находит заголовки и содержимое источников, инсайты, а также заголовки и содержимое заметок.",
    searchCoverageVector: "Векторный поиск находит содержимое источников, инсайты и содержимое заметок по семантическому сходству. Заголовки не учитываются.",
    ...
    scopeNotebooks: "Блокноты",
    scopeAllNotebooks: "Все блокноты",
    scopeNotebooksSelected: "Выбрано: {{count}}",
    scopeClear: "Сбросить",
    scopeHint: "Ничего не отмечайте, чтобы искать по всей базе знаний.",
    scopeNoNotebooks: "Блокнотов пока нет.",
  ...
  podcasts: {
    ...
    speakerProfileMissing: "Профиль голосов отсутствует",
    speakerProfileMissingDesc: "Этот профиль эпизода ссылается на профиль голосов, который больше не существует. Отредактируйте профиль и выберите профиль голосов.",
    ...
    maxTokensPlaceholder: "Оставьте пустым для значений по умолчанию",
    maxTokensHelp: "Необязательно. Ограничивает, сколько токенов может создать каждый шаг генерации — план и полный сценарий, — это не ограничение на отдельную реплику или на весь разговор. Оставьте пустым, чтобы использовать встроенные значения по умолчанию (3000 для плана, 5000 для сценария). Увеличьте для более длинных выпусков; слишком низкое значение может оборвать сценарий.",
    ...
    maxTokensInteger: "Должно быть целым числом",
    maxTokensPositive: "Должно быть положительным целым числом",
  ...
  settings: {
    ...
    ocrEnabled: "Включить OCR",
    ocrHelp: "Извлекает текст из отсканированных PDF и изображений при использовании движка Docling. Обработка медленнее.",
    formulasEnabled: "Извлекать формулы",
    formulasHelp: "Извлекает математические формулы в виде структурированной разметки при использовании движка Docling. Увеличивает время обработки.",
  ...
  models: {
    ...
    usingChatModelHint: "Используется модель чата ({{model}})",
    ttsUnsetHint: "Не задано — генерация аудио недоступна до настройки",
    sttUnsetHint: "Не задано — транскрипция недоступна до настройки",
  ...
  apiKeys: {
    title: "Модели",
    description: "Подключите своих ИИ-провайдеров и безопасно храните их учётные данные.",
    ...
    learnMore: "Узнайте, как подключить ИИ-провайдеров →",
    ...
    openAICompatibleBaseUrlHint: "Укажите путь версии API, необходимый серверу. Для LM Studio в Docker используйте http://host.docker.internal:1234/v1.",
