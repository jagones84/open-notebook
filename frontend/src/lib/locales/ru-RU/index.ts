...
export const ruRU = {
  ...
  artifacts: {
    ...
    kindDeck: "Slides",
    variantLabel: "Style",
    variantDocument: "Document (prose only)",
    variantIllustrated: "Illustrated (with diagrams)",
    variantPresenter: "Presenter (bullets)",
    variantDetailed: "Detailed (full sentences)",
