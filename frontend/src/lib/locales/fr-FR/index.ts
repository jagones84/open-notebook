...
export const frFR = {
  ...
  searchPage: {
    ...
    searchCoverageText: "La recherche textuelle trouve les titres et contenus des sources, les aperçus, ainsi que les titres et contenus des notes.",
    searchCoverageVector: "La recherche vectorielle trouve le contenu des sources, les aperçus et le contenu des notes par similarité sémantique. Les titres ne sont pas pris en compte.",
    ...
    scopeNotebooks: "Carnets",
    scopeAllNotebooks: "Tous les carnets",
    scopeNotebooksSelected: "{{count}} sélectionné(s)",
    scopeClear: "Effacer",
    scopeHint: "Ne cochez rien pour rechercher dans toute la base de connaissances.",
    scopeNoNotebooks: "Aucun carnet pour le moment.",
  ...
  podcasts: {
    ...
    maxTokensInteger: "Doit être un nombre entier",
    maxTokensPositive: "Doit être un nombre entier positif",
  ...
  settings: {
    ...
    jina: "Jina",
    crawl4ai: "Crawl4AI",
    enableDoclingHint: "Docling est facultatif. Activez-le avec OPEN_NOTEBOOK_ENABLE_DOCLING=true — il s'installe au premier démarrage (téléchargement volumineux).",
    enableCrawl4aiHint: "Crawl4AI local est facultatif. Activez-le avec OPEN_NOTEBOOK_ENABLE_CRAWL4AI=true (s'installe au premier démarrage), ou définissez CRAWL4AI_API_URL pour utiliser un serveur distant.",
    ...
    formulasEnabled: "Extraire les formules",
    formulasHelp: "Extrait les formules mathématiques sous forme de balisage structuré avec le moteur Docling. Augmente le temps de traitement.",
  ...
  models: {
    ...
    usingChatModelHint: "Utilisation du modèle de chat ({{model}})",
    ttsUnsetHint: "Non défini — génération audio indisponible tant qu'il n'est pas configuré",
    sttUnsetHint: "Non défini — transcription indisponible tant qu'elle n'est pas configurée",
  ...
  apiKeys: {
    title: "Modèles",
    description: "Connectez vos fournisseurs d'IA et stockez leurs identifiants en toute sécurité.",
    ...
    learnMore: "Apprenez à connecter des fournisseurs d'IA →",
