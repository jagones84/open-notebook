...
export const itIT = {
  ...
  discover: {
    title: "Scopri",
    subtitle: "Cerca sul web e aggiungi i risultati migliori a un notebook come fonti.",
    topicLabel: "Tema",
    topicPlaceholder: "es. basi del calcolo quantistico",
    notebookLabel: "Notebook",
    notebookPlaceholder: "Scegli un notebook",
    noNotebooks: "Crea prima un notebook, poi torna qui per scoprire le fonti.",
    limitLabel: "Numero massimo di risultati",
    dryRunLabel: "Solo anteprima (non aggiungere fonti)",
    submit: "Cerca",
    submitting: "Ricerca in corso...",
    summary: "{{created}} aggiunte, {{skipped}} saltate",
    openNotebook: "Apri il notebook",
    emptyState: "Nessun risultato. Cerca un tema per vedere i candidati qui.",
    colTitle: "Titolo",
    colUrl: "Fonte",
    colScore: "Punteggio",
    colStatus: "Stato",
    statusCandidate: "Candidato",
    statusCreated: "Aggiunta",
    statusSkipped: "Già presente",
    statusError: "Rifiutata",
  },
  artifacts: {
    title: "Artefatti",
    subtitle: "Genera un report o una presentazione dalle fonti di un quaderno.",
    formTitle: "Genera un artefatto",
    notebookLabel: "Quaderno",
    notebookPlaceholder: "Seleziona un quaderno",
    noNotebooks: "Crea prima un quaderno, poi torna qui per generare un artefatto.",
    kindLabel: "Tipo",
    kindReport: "Report",
    kindDeck: "Presentazione",
    variantLabel: "Style",
    ...
    titleLabel: "Titolo del documento (opzionale)",
    titlePlaceholder: "es. Panoramica DGX Spark",
    formatsLabel: "Formati di output",
    languageLabel: "Lingua",
    sectionsLabel: "Sezioni",
    submit: "Genera",
    submitting: "Invio...",
    listTitle: "Artefatti generati",
    emptyState: "Nessun artefatto. Generane uno da un quaderno qui sopra.",
    colTitle: "Titolo",
    colKind: "Tipo",
    colStatus: "Stato",
    colCreated: "Creato",
    ...
    download: "Scarica",
    delete: "Elimina",
    deleteTitle: "Elimina artefatto",
    deleteDesc: "Il record dell'artefatto e i suoi file verranno eliminati definitivamente.",
    startedTitle: "Artefatto in coda",
    startedDesc: "Generazione avviata. Comparirà qui quando sarà pronto.",
    deletedTitle: "Artefatto eliminato",
    deletedDesc: "L'artefatto e i suoi file sono stati rimossi.",
    noFileYet: "Nessun file",
    openNote: "Apri quaderno",
  },
  navigation: {
    artifacts: "Artefatti",
    discover: "Scopri",
