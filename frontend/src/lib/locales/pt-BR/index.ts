...
export const ptBR = {
  ...
  searchPage: {
    ...
    searchCoverageText: "A busca por texto encontra títulos e conteúdo das fontes, insights e títulos e conteúdo das notas.",
    searchCoverageVector: "A busca vetorial encontra conteúdo das fontes, insights e conteúdo das notas por similaridade semântica. Títulos não são correspondidos.",
    ...
    scopeNotebooks: "Cadernos",
    scopeAllNotebooks: "Todos os cadernos",
    scopeNotebooksSelected: "{{count}} selecionado(s)",
    scopeClear: "Limpar",
    scopeHint: "Deixe tudo desmarcado para buscar em toda a base de conhecimento.",
    scopeNoNotebooks: "Nenhum caderno ainda.",
  ...
  podcasts: {
    ...
    maxTokensInteger: "Deve ser um número inteiro",
    maxTokensPositive: "Deve ser um número inteiro positivo",
  ...
  settings: {
    ...
    formulasEnabled: "Extrair fórmulas",
    formulasHelp: "Extrai fórmulas matemáticas como marcação estruturada ao usar o mecanismo Docling. Aumenta o tempo de processamento.",
  ...
  models: {
    ...
    usingChatModelHint: "Usando o modelo de chat ({{model}})",
    ttsUnsetHint: "Não configurado — geração de áudio indisponível até ser configurado",
    sttUnsetHint: "Não configurado — transcrição indisponível até ser configurado",
  ...
  apiKeys: {
    title: "Modelos",
    description: "Conecte seus provedores de IA e armazene suas credenciais com segurança.",
    ...
    learnMore: "Saiba como conectar provedores de IA →",
