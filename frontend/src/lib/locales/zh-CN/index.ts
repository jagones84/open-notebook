...
export const zhCN = {
  ...
  searchPage: {
    ...
    searchCoverageText: "文本搜索会匹配来源标题和内容、洞察，以及笔记标题和内容。",
    searchCoverageVector: "向量搜索通过语义相似度匹配来源内容、洞察和笔记内容。标题不会被匹配。",
    searchType: "搜索类型",
    ...
    searchNotes: "搜索笔记",
    scopeNotebooks: "笔记本",
    scopeAllNotebooks: "所有笔记本",
    scopeNotebooksSelected: "已选择 {{count}} 个",
    scopeClear: "清除",
    scopeHint: "不勾选任何项则搜索整个知识库。",
    scopeNoNotebooks: "还没有笔记本。",
  ...
  podcasts: {
    ...
    maxTokensInteger: "必须为整数",
    maxTokensPositive: "必须为正整数",
  ...
  settings: {
    ...
    jina: "Jina",
    crawl4ai: "Crawl4AI",
    enableDoclingHint: "Docling 为可选项。使用 OPEN_NOTEBOOK_ENABLE_DOCLING=true 启用，首次启动时安装（下载较大）。",
    enableCrawl4aiHint: "本地 Crawl4AI 为可选项。使用 OPEN_NOTEBOOK_ENABLE_CRAWL4AI=true 启用（首次启动时安装），或设置 CRAWL4AI_API_URL 以使用远程服务器。",
    ...
    formulasEnabled: "提取公式",
    formulasHelp: "使用 Docling 引擎时，将数学公式提取为结构化标记。会增加处理时间。",
  ...
  models: {
    ...
    ttsUnsetHint: "未设置 — 配置前无法生成音频",
    sttUnsetHint: "未设置 — 配置前无法转录",
  ...
  apiKeys: {
    title: "模型",
    description: "连接您的 AI 服务商，并安全地存储其凭据。",
    ...
    openAICompatibleBaseUrlHint: "请包含服务器所需的 API 版本路径。对于 Docker 中的 LM Studio，请使用 http://host.docker.internal:1234/v1。",
